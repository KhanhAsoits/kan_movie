    ...
    return (
        <Box flex={1} py={ThemeStore.mode === "light" ? 0 : 2} bgColor={ThemeStore.baseProps.themeBg}>
            <HStack width={SCREEN_WIDTH - 30}  alignSelf={'center'} my={4} justifyContent={'space-between'}
                    alignItems={'center'}>
                <BackButton size={36} color={ThemeStore.baseProps.text_24} handleBack={() => {
                    ...
                    <HStack space={2} justifyContent={'center'} alignItems={'center'}>
                        ...
                        <VStack space={0}>
                            <Text fontWeight={'500'} fontSize={16} letterSpacing={1.2}
                                  color={ThemeStore.baseProps.text_24}>{SingleMovieStore.movie?.title}</Text>
                ...
                {PaypalStore.processing ?
                    ...
                    <HelpButton size={36} color={ThemeStore.baseProps.text_24} message={props.helpTitle ? props.helpTitle : 'Help Button'}/>
                }
            </HStack>
            {props.children}
        </Box>
